...
function index()
	...
	page = entry({"admin", "advanced", "openclash"}, alias("admin", "advanced", "openclash", "client"), _("OpenClash"), 50)
	page.dependent = true
	page.acl_depends = { "luci-app-openclash" }
	entry({"admin", "advanced", "openclash", "client"},form("openclash/client"),_("Overviews"), 20).leaf = true
	entry({"admin", "advanced", "openclash", "status"},call("action_status")).leaf=true
	entry({"admin", "advanced", "openclash", "state"},call("action_state")).leaf=true
	entry({"admin", "advanced", "openclash", "startlog"},call("action_start")).leaf=true
	entry({"admin", "advanced", "openclash", "refresh_log"},call("action_refresh_log"))
	entry({"admin", "advanced", "openclash", "del_log"},call("action_del_log"))
	entry({"admin", "advanced", "openclash", "del_start_log"},call("action_del_start_log"))
	entry({"admin", "advanced", "openclash", "close_all_connection"},call("action_close_all_connection"))
	entry({"admin", "advanced", "openclash", "reload_firewall"},call("action_reload_firewall"))
	entry({"admin", "advanced", "openclash", "update_subscribe"},call("action_update_subscribe"))
	entry({"admin", "advanced", "openclash", "update_other_rules"},call("action_update_other_rules"))
	entry({"admin", "advanced", "openclash", "update_geoip"},call("action_update_geoip"))
	entry({"admin", "advanced", "openclash", "update_geosite"},call("action_update_geosite"))
	entry({"admin", "advanced", "openclash", "lastversion"},call("action_lastversion"))
	entry({"admin", "advanced", "openclash", "save_corever_branch"},call("action_save_corever_branch"))
	entry({"admin", "advanced", "openclash", "update"},call("action_update"))
	entry({"admin", "advanced", "openclash", "update_info"},call("action_update_info"))
	entry({"admin", "advanced", "openclash", "update_ma"},call("action_update_ma"))
	entry({"admin", "advanced", "openclash", "opupdate"},call("action_opupdate"))
	entry({"admin", "advanced", "openclash", "coreupdate"},call("action_coreupdate"))
	entry({"admin", "advanced", "openclash", "flush_fakeip_cache"}, call("action_flush_fakeip_cache"))
	entry({"admin", "advanced", "openclash", "download_rule"}, call("action_download_rule"))
	entry({"admin", "advanced", "openclash", "download_netflix_domains"}, call("action_download_netflix_domains"))
	entry({"admin", "advanced", "openclash", "download_disney_domains"}, call("action_download_disney_domains"))
	entry({"admin", "advanced", "openclash", "catch_netflix_domains"}, call("action_catch_netflix_domains"))
	entry({"admin", "advanced", "openclash", "write_netflix_domains"}, call("action_write_netflix_domains"))
	entry({"admin", "advanced", "openclash", "restore"}, call("action_restore_config"))
	entry({"admin", "advanced", "openclash", "backup"}, call("action_backup"))
	entry({"admin", "advanced", "openclash", "backup_ex_core"}, call("action_backup_ex_core"))
	entry({"admin", "advanced", "openclash", "backup_only_core"}, call("action_backup_only_core"))
	entry({"admin", "advanced", "openclash", "backup_only_config"}, call("action_backup_only_config"))
	entry({"admin", "advanced", "openclash", "backup_only_rule"}, call("action_backup_only_rule"))
	entry({"admin", "advanced", "openclash", "backup_only_proxy"}, call("action_backup_only_proxy"))
	entry({"admin", "advanced", "openclash", "remove_all_core"}, call("action_remove_all_core"))
	entry({"admin", "advanced", "openclash", "one_key_update"}, call("action_one_key_update"))
	entry({"admin", "advanced", "openclash", "one_key_update_check"}, call("action_one_key_update_check"))
	entry({"admin", "advanced", "openclash", "switch_mode"}, call("action_switch_mode"))
	entry({"admin", "advanced", "openclash", "op_mode"}, call("action_op_mode"))
	entry({"admin", "advanced", "openclash", "dler_info"}, call("action_dler_info"))
	entry({"admin", "advanced", "openclash", "dler_checkin"}, call("action_dler_checkin"))
	entry({"admin", "advanced", "openclash", "dler_logout"}, call("action_dler_logout"))
	entry({"admin", "advanced", "openclash", "dler_login"}, call("action_dler_login"))
	entry({"admin", "advanced", "openclash", "dler_login_info_save"}, call("action_dler_login_info_save"))
	entry({"admin", "advanced", "openclash", "sub_info_get"}, call("sub_info_get"))
	entry({"admin", "advanced", "openclash", "config_name"}, call("action_config_name"))
	entry({"admin", "advanced", "openclash", "switch_config"}, call("action_switch_config"))
	entry({"admin", "advanced", "openclash", "toolbar_show"}, call("action_toolbar_show"))
	entry({"admin", "advanced", "openclash", "toolbar_show_sys"}, call("action_toolbar_show_sys"))
	entry({"admin", "advanced", "openclash", "diag_connection"}, call("action_diag_connection"))
	entry({"admin", "advanced", "openclash", "diag_dns"}, call("action_diag_dns"))
	entry({"admin", "advanced", "openclash", "gen_debug_logs"}, call("action_gen_debug_logs"))
	entry({"admin", "advanced", "openclash", "log_level"}, call("action_log_level"))
	entry({"admin", "advanced", "openclash", "switch_log"}, call("action_switch_log"))
	entry({"admin", "advanced", "openclash", "rule_mode"}, call("action_rule_mode"))
	entry({"admin", "advanced", "openclash", "switch_rule_mode"}, call("action_switch_rule_mode"))
	entry({"admin", "advanced", "openclash", "switch_run_mode"}, call("action_switch_run_mode"))
	entry({"admin", "advanced", "openclash", "dashboard_type"}, call("action_dashboard_type"))
	entry({"admin", "advanced", "openclash", "switch_dashboard"}, call("action_switch_dashboard"))
	entry({"admin", "advanced", "openclash", "get_run_mode"}, call("action_get_run_mode"))
	entry({"admin", "advanced", "openclash", "create_file"}, call("create_file"))
	entry({"admin", "advanced", "openclash", "rename_file"}, call("rename_file"))
	entry({"admin", "advanced", "openclash", "manual_stream_unlock_test"}, call("manual_stream_unlock_test"))
	entry({"admin", "advanced", "openclash", "all_proxies_stream_test"}, call("all_proxies_stream_test"))
	entry({"admin", "advanced", "openclash", "set_subinfo_url"}, call("set_subinfo_url"))
	entry({"admin", "advanced", "openclash", "settings"},cbi("openclash/settings"),_("Plugin Settings"), 30).leaf = true
	entry({"admin", "advanced", "openclash", "config-overwrite"},cbi("openclash/config-overwrite"),_("Overwrite Settings"), 40).leaf = true
	entry({"admin", "advanced", "openclash", "servers"},cbi("openclash/servers"),_("Onekey Create"), 50).leaf = true
	entry({"admin", "advanced", "openclash", "other-rules-edit"},cbi("openclash/other-rules-edit"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "custom-dns-edit"},cbi("openclash/custom-dns-edit"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "other-file-edit"},cbi("openclash/other-file-edit"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "rule-providers-settings"},cbi("openclash/rule-providers-settings"),_("Rule Providers Append"), 60).leaf = true
	entry({"admin", "advanced", "openclash", "game-rules-manage"},form("openclash/game-rules-manage"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "rule-providers-manage"},form("openclash/rule-providers-manage"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "proxy-provider-file-manage"},form("openclash/proxy-provider-file-manage"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "rule-providers-file-manage"},form("openclash/rule-providers-file-manage"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "game-rules-file-manage"},form("openclash/game-rules-file-manage"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "config-subscribe"},cbi("openclash/config-subscribe"),_("Config Subscribe"), 70).leaf = true
	entry({"admin", "advanced", "openclash", "config-subscribe-edit"},cbi("openclash/config-subscribe-edit"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "servers-config"},cbi("openclash/servers-config"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "groups-config"},cbi("openclash/groups-config"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "proxy-provider-config"},cbi("openclash/proxy-provider-config"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "rule-providers-config"},cbi("openclash/rule-providers-config"), nil).leaf = true
	entry({"admin", "advanced", "openclash", "config"},form("openclash/config"),_("Config Manage"), 80).leaf = true
	entry({"admin", "advanced", "openclash", "log"},cbi("openclash/log"),_("Server Logs"), 90).leaf = true
...
function action_restore_config()
	...
	luci.http.redirect(luci.dispatcher.build_url('admin/advanced/openclash/settings'))
end
